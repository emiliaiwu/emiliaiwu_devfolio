...
export const projectData = [
	{
		...
		title: "Devvie ",
		description:
			"Devvie is a project management web application for aspiring developers. It helps them to build, track and manage their personal projects. They can also save relevant links, publish their profile and stay productive while learning to code.",
		url: "https://devvie.netlify.app",
		hasCaseStudy: true,
		caseStudyLink: "/devvie-app",
		sourceCode: "https://github.com/emiliaiwu/devvie-app",
		type: "WebApp",
		techStack: ["React JS", "Tailwind", "JavaScript", "CSS", "Framer Motion"],
	},
	{
		image: maveli,
		title: "Maveli ",
		description:
			"Maveli React website offers a seamless user experience with its dynamic interface and smooth navigation. Leveraging the power of React, I crafted a modern and responsive design that adapts effortlessly to various devices and screen sizes.",
		url: "https://maveli.netlify.app",
		hasCaseStudy: false,
		caseStudyLink: "",
		sourceCode: "https://github.com/emiliaiwu/maveli-website",
		type: "Website",
...
export const socialLinks = [
	// {
	// 	icon: Mail,
	// 	url: "mailto:emiliaiwuc@gmail.com?Subject=Hello%20Emilia",
	// 	title: "Email",
	// },
...
export const casestudies = [
	{
		...
		image: heroImg,
		description:
			"Devvie is a platform designed for growth and success of aspiring developers.",
		solution:
			"Devvie is a project management web application for aspiring developers. It helps them to build, track and manage their personal projects. They can also save relevant links, publish their profile and stay productive while learning to code.",
		problem:
			"Aspiring developers often face challenges in effectively managing their personal coding projects, tracking their progress, and staying organized with relevant resources. Without a structured approach, they may struggle to maintain momentum, lose track of tasks, and miss out on valuable learning opportunities.",
		role: ["UI Design", "Frontend Development", "BAAS"],
		techStack: [
			"React JS",
			"Firebase",
			"Tailwind CSS",
		...
		features: [
			...
			},
			{
				...
				details:
					"Task Management in Devvie empowers you to break down your projects into manageable tasks, enabling a more structured approach to project development. For each project you create, you can set tasks, assign priorities, deadlines, and track their completion status.",
				image: task,
			},
			{
				name: "Resource Library",
				details:
					"Save and organize relevant links, tutorials, documentation, and other resources for easy access during project development. Devvie's link collections keep your resources at your fingertips, streamlining your workflow.",
				image: library,
			},
			{
